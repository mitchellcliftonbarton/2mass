...
export default Ember.Route.extend(AuthenticatedRouteMixin, {
  ...
  actions: {
    ...
    createPerson() {
      ...
      let { name } = this.controller.getProperties('name');
      let form = document.getElementById('create-person-form');
      let formChildren = form.children;
      let dropdown = document.getElementById('person-list');
    ...
    loadImage() {
      ...
      let pageName = getText('person-list');
      console.log(pageName);
      let form = document.getElementById('create-person-form').children;
      // console.log(form);
      let newData = this.get('store').peekRecord('person', pageName);
      console.log(newData);
